...
public partial class HUDReplacer : MonoBehaviour
{
    ...
    private static readonly Dictionary<string, ReplacementInfo> Empty =
        new Dictionary<string, ReplacementInfo>();
    ...
    public void Update()
    {
        if (enableDebug)
        {
            if (Input.GetKeyUp(KeyCode.E))
            {
                ...
                Texture2D[] tex_array = (Texture2D[])
                    (object)Resources.FindObjectsOfTypeAll(typeof(Texture2D));
            ...
            if (Input.GetKeyUp(KeyCode.D))
            {
                ...
                foreach (RaycastResult result in results)
                {
                    try
                    {
                        ...
                        //Debug.Log("HUDReplacer: ------");
                        Debug.Log(
                            "Image.mainTexture.name: "
                                + img.mainTexture.name
                                + " - WxH="
                                + img.mainTexture.width
                                + "x"
                                + img.mainTexture.height
                        );
                        Debug.Log(
                            "Image.sprite.texture.name: "
                                + img.sprite.texture.name
                                + " - WxH="
                                + img.sprite.texture.width
                                + "x"
                                + img.sprite.texture.height
                        );
                        Debug.Log("HUDReplacer: ------");
                        if (
                            img.mainTexture.name == "app_divider_pulldown_header"
    ...
    static void LoadTextures()
    {
        ...
        UrlDir.UrlConfig[] configs = GameDatabase
        ...
        foreach (UrlDir.UrlConfig configFile in configs)
        {
            ...
            if (configFile.config.HasValue(PAWTitleBar))
            {
                if (!colorsSet.Contains(PAWTitleBar))
                {
                    ...
                    HarmonyPatches.PAWTitleBar_color = configFile
                        .config.GetValue(PAWTitleBar)
                        .ToRGBA();
            ...
            if (configFile.config.HasValue(PAWBlueButton))
            {
                if (!colorsSet.Contains(PAWBlueButton))
                {
                    ...
                    HarmonyPatches.PAWBlueButton_color = configFile
                        .config.GetValue(PAWBlueButton)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(PAWBlueButtonToggle))
            {
                if (!colorsSet.Contains(PAWBlueButtonToggle))
                {
                    ...
                    HarmonyPatches.PAWBlueButtonToggle_color = configFile
                        .config.GetValue(PAWBlueButtonToggle)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(PAWVariantSelectorNext))
            {
                if (!colorsSet.Contains(PAWVariantSelectorNext))
                {
                    ...
                    HarmonyPatches.PAWVariantSelectorNext_color = configFile
                        .config.GetValue(PAWVariantSelectorNext)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(PAWVariantSelectorPrevious))
            {
                if (!colorsSet.Contains(PAWVariantSelectorPrevious))
                {
                    ...
                    HarmonyPatches.PAWVariantSelectorPrevious_color = configFile
                        .config.GetValue(PAWVariantSelectorPrevious)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(PAWResourcePriorityIncrease))
            {
                if (!colorsSet.Contains(PAWResourcePriorityIncrease))
                {
                    ...
                    HarmonyPatches.PAWResourcePriorityIncrease_color = configFile
                        .config.GetValue(PAWResourcePriorityIncrease)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(PAWResourcePriorityDecrease))
            {
                if (!colorsSet.Contains(PAWResourcePriorityDecrease))
                {
                    ...
                    HarmonyPatches.PAWResourcePriorityDecrease_color = configFile
                        .config.GetValue(PAWResourcePriorityDecrease)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(PAWResourcePriorityReset))
            {
                if (!colorsSet.Contains(PAWResourcePriorityReset))
                {
                    ...
                    HarmonyPatches.PAWResourcePriorityReset_color = configFile
                        .config.GetValue(PAWResourcePriorityReset)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(PAWFuelSliderColor))
            {
                if (!colorsSet.Contains(PAWFuelSliderColor))
                {
                    ...
                    HarmonyPatches.PAWFuelSliderColor = configFile
                        .config.GetValue(PAWFuelSliderColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(PAWFuelSliderTextColor))
            {
                if (!colorsSet.Contains(PAWFuelSliderTextColor))
                {
                    ...
                    HarmonyPatches.PAWFuelSliderTextColor = configFile
                        .config.GetValue(PAWFuelSliderTextColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(KALTitleBar))
            {
                if (!colorsSet.Contains(KALTitleBar))
                {
                    ...
                    HarmonyPatches.KALTitleBar_color = configFile
                        .config.GetValue(KALTitleBar)
                        .ToRGBA();
            ...
            if (configFile.config.HasValue(gaugeNeedleYawPitchRoll))
            {
                if (!colorsSet.Contains(gaugeNeedleYawPitchRoll))
                {
                    ...
                    HarmonyPatches.gaugeNeedleYawPitchRollColor = configFile
                        .config.GetValue(gaugeNeedleYawPitchRoll)
                        .ToRGBA();
            ...
            if (configFile.config.HasValue(gaugeNeedleYawPitchRollPrecision))
            {
                if (!colorsSet.Contains(gaugeNeedleYawPitchRollPrecision))
                {
                    ...
                    HarmonyPatches.gaugeNeedleYawPitchRollPrecisionColor = configFile
                        .config.GetValue(gaugeNeedleYawPitchRollPrecision)
                        .ToRGBA();
            ...
            if (configFile.config.HasValue(METDisplayColorRed))
            {
                if (!colorsSet.Contains(METDisplayColorRed))
                {
                    ...
                    HarmonyPatches.METDisplayColorRed = configFile
                        .config.GetValue(METDisplayColorRed)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(METDisplayColorYellow))
            {
                if (!colorsSet.Contains(METDisplayColorYellow))
                {
                    ...
                    HarmonyPatches.METDisplayColorYellow = configFile
                        .config.GetValue(METDisplayColorYellow)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(METDisplayColorGreen))
            {
                if (!colorsSet.Contains(METDisplayColorGreen))
                {
                    ...
                    HarmonyPatches.METDisplayColorGreen = configFile
                        .config.GetValue(METDisplayColorGreen)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(SpeedDisplayColorTextReplace))
            {
                if (!colorsSet.Contains(SpeedDisplayColorTextReplace))
                {
                    ...
                    HarmonyPatches.SpeedDisplayColorText = configFile
                        .config.GetValue(SpeedDisplayColorTextReplace)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(SpeedDisplayColorSpeedReplace))
            {
                if (!colorsSet.Contains(SpeedDisplayColorSpeedReplace))
                {
                    ...
                    HarmonyPatches.SpeedDisplayColorSpeed = configFile
                        .config.GetValue(SpeedDisplayColorSpeedReplace)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(NavBallHeadingColor))
            {
                if (!colorsSet.Contains(NavBallHeadingColor))
                {
                    ...
                    HarmonyPatches.NavBallHeadingColor = configFile
                        .config.GetValue(NavBallHeadingColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageTotalDeltaVColor))
            {
                if (!colorsSet.Contains(StageTotalDeltaVColor))
                {
                    ...
                    HarmonyPatches.StageTotalDeltaVColor = configFile
                        .config.GetValue(StageTotalDeltaVColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageGroupDeltaVTextColor))
            {
                if (!colorsSet.Contains(StageGroupDeltaVTextColor))
                {
                    ...
                    HarmonyPatches.StageGroupDeltaVTextColor = configFile
                        .config.GetValue(StageGroupDeltaVTextColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageGroupDeltaVNumberColor))
            {
                if (!colorsSet.Contains(StageGroupDeltaVNumberColor))
                {
                    ...
                    HarmonyPatches.StageGroupDeltaVNumberColor = configFile
                        .config.GetValue(StageGroupDeltaVNumberColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageGroupDeltaVBackgroundColor))
            {
                if (!colorsSet.Contains(StageGroupDeltaVBackgroundColor))
                {
                    ...
                    HarmonyPatches.StageGroupDeltaVBackgroundColor = configFile
                        .config.GetValue(StageGroupDeltaVBackgroundColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageEngineFuelGaugeTextColor))
            {
                if (!colorsSet.Contains(StageEngineFuelGaugeTextColor))
                {
                    ...
                    HarmonyPatches.StageEngineFuelGaugeTextColor_color = configFile
                        .config.GetValue(StageEngineFuelGaugeTextColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageEngineHeatGaugeTextColor))
            {
                if (!colorsSet.Contains(StageEngineHeatGaugeTextColor))
                {
                    ...
                    HarmonyPatches.StageEngineHeatGaugeTextColor_color = configFile
                        .config.GetValue(StageEngineHeatGaugeTextColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageEngineFuelGaugeBackgroundColor))
            {
                if (!colorsSet.Contains(StageEngineFuelGaugeBackgroundColor))
                {
                    ...
                    HarmonyPatches.StageEngineFuelGaugeBackgroundColor_color = configFile
                        .config.GetValue(StageEngineFuelGaugeBackgroundColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageEngineHeatGaugeBackgroundColor))
            {
                if (!colorsSet.Contains(StageEngineHeatGaugeBackgroundColor))
                {
                    ...
                    HarmonyPatches.StageEngineHeatGaugeBackgroundColor_color = configFile
                        .config.GetValue(StageEngineHeatGaugeBackgroundColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageEngineFuelGaugeFillColor))
            {
                if (!colorsSet.Contains(StageEngineFuelGaugeFillColor))
                {
                    ...
                    HarmonyPatches.StageEngineFuelGaugeFillColor_color = configFile
                        .config.GetValue(StageEngineFuelGaugeFillColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(StageEngineHeatGaugeFillColor))
            {
                if (!colorsSet.Contains(StageEngineHeatGaugeFillColor))
                {
                    ...
                    HarmonyPatches.StageEngineHeatGaugeFillColor_color = configFile
                        .config.GetValue(StageEngineHeatGaugeFillColor)
                        .ToRGBA();
                }
            }

            string StageEngineFuelGaugeFillBackgroundColor =
                "stageEngineFuelGaugeFillBackgroundColor";
            if (configFile.config.HasValue(StageEngineFuelGaugeFillBackgroundColor))
            {
                if (!colorsSet.Contains(StageEngineFuelGaugeFillBackgroundColor))
                {
                    ...
                    HarmonyPatches.StageEngineFuelGaugeFillBackgroundColor_color = configFile
                        .config.GetValue(StageEngineFuelGaugeFillBackgroundColor)
                        .ToRGBA();
                }
            }

            string StageEngineHeatGaugeFillBackgroundColor =
                "stageEngineHeatGaugeFillBackgroundColor";
            if (configFile.config.HasValue(StageEngineHeatGaugeFillBackgroundColor))
            {
                if (!colorsSet.Contains(StageEngineHeatGaugeFillBackgroundColor))
                {
                    ...
                    HarmonyPatches.StageEngineHeatGaugeFillBackgroundColor_color = configFile
                        .config.GetValue(StageEngineHeatGaugeFillBackgroundColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(NavBallCursor))
            {
                if (!colorsSet.Contains(NavBallCursor))
                {
                    ...
                    GameObject go = GameObject.Find(
                        "_UIMaster/MainCanvas/Flight/NavballFrame/IVAEVACollapseGroup/NavBallCursor"
                    );
                    if (go != null)
                    {
            ...
            if (configFile.config.HasValue(VerticalSpeedGaugeNeedle))
            {
                if (!colorsSet.Contains(VerticalSpeedGaugeNeedle))
                {
                    ...
                    HarmonyPatches.VerticalSpeedGaugeNeedleColor = configFile
                        .config.GetValue(VerticalSpeedGaugeNeedle)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(ManeuverNodeEditorTextColor))
            {
                if (!colorsSet.Contains(ManeuverNodeEditorTextColor))
                {
                    ...
                    HarmonyPatches.ManeuverNodeEditorTextColor = configFile
                        .config.GetValue(ManeuverNodeEditorTextColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(SASDisplayOnColor))
            {
                if (!colorsSet.Contains(SASDisplayOnColor))
                {
                    ...
                    HarmonyPatches.SASDisplayColor_SAS_On_color = configFile
                        .config.GetValue(SASDisplayOnColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(SASDisplayOffColor))
            {
                if (!colorsSet.Contains(SASDisplayOffColor))
                {
                    ...
                    HarmonyPatches.SASDisplayColor_SAS_Off_color = configFile
                        .config.GetValue(SASDisplayOffColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(RCSDisplayOnColor))
            {
                if (!colorsSet.Contains(RCSDisplayOnColor))
                {
                    ...
                    HarmonyPatches.RCSDisplayColor_RCS_On_color = configFile
                        .config.GetValue(RCSDisplayOnColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(RCSDisplayOffColor))
            {
                if (!colorsSet.Contains(RCSDisplayOffColor))
                {
                    ...
                    HarmonyPatches.RCSDisplayColor_RCS_Off_color = configFile
                        .config.GetValue(RCSDisplayOffColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_color = configFile
                        .config.GetValue(EditorCategoryButtonColor)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor_Module))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor_Module))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_Module_color = configFile
                        .config.GetValue(EditorCategoryButtonColor_Module)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor_Resource))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor_Resource))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_Resource_color = configFile
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor_Manufacturer))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor_Manufacturer))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_Manufacturer_color = configFile
                        .config.GetValue(EditorCategoryButtonColor_Manufacturer)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor_Tech))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor_Tech))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_Tech_color = configFile
                        .config.GetValue(EditorCategoryButtonColor_Tech)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor_Profile))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor_Profile))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_Profile_color = configFile
                        .config.GetValue(EditorCategoryButtonColor_Profile)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor_Subassembly))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor_Subassembly))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_Subassembly_color = configFile
                        .config.GetValue(EditorCategoryButtonColor_Subassembly)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor_Variants))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor_Variants))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_Variants_color = configFile
                        .config.GetValue(EditorCategoryButtonColor_Variants)
                        .ToRGBA();
                }
            }
            ...
            if (configFile.config.HasValue(EditorCategoryButtonColor_Custom))
            {
                if (!colorsSet.Contains(EditorCategoryButtonColor_Custom))
                {
                    ...
                    HarmonyPatches.EditorCategoryButtonColor_Custom_color = configFile
                        .config.GetValue(EditorCategoryButtonColor_Custom)
                        .ToRGBA();
                }
            }
        }
